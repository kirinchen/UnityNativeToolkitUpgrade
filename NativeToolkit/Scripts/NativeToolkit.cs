...
public class NativeToolkit : MonoBehaviour {
    ...
    private static IDisposable pickImageDis;
    ...
    public static void PickImage()
	{
        ...
        if (Application.platform == RuntimePlatform.Android) {
            ...
            pickImageDis = Observable
            .EveryUpdate()
            .Where(_=> Permission.HasUserAuthorizedPermission(Permission.ExternalStorageRead))
            .Subscribe(x => {
                obj.CallStatic("pickImageFromGallery");
                pickImageDis.Dispose();
            } );
